...
public class ItemsController : ControllerBase
{
    ...
    {
        var exitingItem = Items.SingleOrDefault(item => item.Id == id);

        if (exitingItem == null) return NotFound();
        ...
        var index = Items.FindIndex(exitingItemList => exitingItemList.Id == id);
